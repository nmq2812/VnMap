                ...
                <div className="flex items-start w-full gap-3">
                    <div className="flex-1">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Hiện chỉ hỗ trợ hàng hóa và tài liệu.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <div className="flex flex-col gap-3 py-2">
                            <h3 className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" >Cam kết của người gửi</h3>
                            <p className="text-justify text-[0.8rem] text-muted-foreground">Tôi đồng ý và chấp nhận tất cả các điều khoản cũng như dịch vụ mà công ty MagicPost cung cấp.
                                Tôi chấp nhận các điều khoản tại mặt sau phiếu gửi và cam đoan bưu gửi
                                này không chứa những mặt hàng nguy hiểm, cám gửi. Trường hợp không
                                phát được hãy thực hiện chỉ dẫn tại mục 6, tôi sẽ trả cước chuyển hoàn.
                            </p>
                        </div>

                        <div className="flex justify-between w-full" >
                            <div className="flex-1 flex flex-col gap-3 py-2">
                                <h3 className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Ngày giờ gửi</h3>
                                <p className="text-[0.8rem] text-muted-foreground">{getCurrentTime()}</p>
                            </div>
                            <div className="flex-1 flex flex-col gap-3 py-2">
                                <h3 className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Chữ ký người gửi</h3>
                    ...
                    <div className=" flex-1" >
                        ...
                        <div className="flex justify-between w-full" >
                            <div className="flex-1 flex flex-col gap-3 py-2">
                                <h3 className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Bưu cục chấp nhận</h3>
                                <p className="text-[0.8rem] text-muted-foreground h-24">{ }</p>
                            </div>
                            <div className="flex-1 flex flex-col gap-3 py-2">
                                <h3 className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Chữ ký người nhận</h3>
...
function getCurrentTime(): string {
    ...
    const formattedDate: string = `${formattedHours}h${formattedMinutes}/${currentDate.getDate()}/${currentDate.getMonth() + 1}/${currentDate.getFullYear()}`;
